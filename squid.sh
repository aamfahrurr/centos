...
if [ $OSystem = 'debian' ]; then
	...
	wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/aamfahrurr/centos/master/squid3.conf"
	sed -i $MYIP2 /etc/squid3/squid.conf;
	service squid3 restart
	rm squid.sh
elif [ $OSystem = 'centos' ]; then
	yum -y install squid
	wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/aamfahrurr/centos/master/squid3.conf"
